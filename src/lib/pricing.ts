...
export function effectiveFileSettings(
  jobDefaults: { printType: PrintType; duplex: PrintDuplex; paperSize: PaperSize; layout: PrintLayout; copies: number; pagesPerSheet: number },
  override: FileSettingsOverride | null | undefined
): { printType: PrintType; duplex: PrintDuplex; paperSize: PaperSize; layout: PrintLayout; copies: number; pagesPerSheet: number } {
  ...
  return {
    ...
    layout: override.layout ?? jobDefaults.layout,
