...
const PRICING_DEFAULTS: PricingConfig = {
  ...
  orderOpenTime: "09:00",
  orderCloseTime: "13:00",
  orderOpenTime2: "16:30",
  orderCloseTime2: "20:30",
  orderDays: "1,2,3,4,5,6",
...
export async function getPricing(): Promise<PricingConfig> {
  ...
  return {
    ...
    bondPaperPerPagePaise: data.bond_paper_per_page_paise ?? PRICING_DEFAULTS.bondPaperPerPagePaise,
    spiralBindingSlab1Paise: data.spiral_binding_slab1_paise ?? PRICING_DEFAULTS.spiralBindingSlab1Paise,
    spiralBindingSlab2Paise: data.spiral_binding_slab2_paise ?? PRICING_DEFAULTS.spiralBindingSlab2Paise,
    spiralBindingSlab3Paise: data.spiral_binding_slab3_paise ?? PRICING_DEFAULTS.spiralBindingSlab3Paise,
    spiralBindingSlab4Paise: data.spiral_binding_slab4_paise ?? PRICING_DEFAULTS.spiralBindingSlab4Paise,
    ...
    orderOpenTime2: data.order_open_time2 ?? null,
    orderCloseTime2: data.order_close_time2 ?? null,
    orderDays: data.order_days ?? PRICING_DEFAULTS.orderDays,
...
export async function updatePricing(pricing: PricingConfig) {
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      bond_paper_per_page_paise: pricing.bondPaperPerPagePaise,
      spiral_binding_slab1_paise: pricing.spiralBindingSlab1Paise,
      spiral_binding_slab2_paise: pricing.spiralBindingSlab2Paise,
      spiral_binding_slab3_paise: pricing.spiralBindingSlab3Paise,
      spiral_binding_slab4_paise: pricing.spiralBindingSlab4Paise,
      ...
      order_open_time2: pricing.orderOpenTime2,
      order_close_time2: pricing.orderCloseTime2,
      order_days: pricing.orderDays,
